...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '探险！发现！, 欢迎来到我的博客，来都来了🥳',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'hiraeth', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '岁岁常欢愉, 万事皆胜意', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.hiraeth1024.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2415779164@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/hi-rath', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  PRISM_THEME_PATH:
      'https://npm.elemecdn.com/prism-themes/themes/prism-vsc-dark-plus.min.css', // 代码样式主题 更多参考 https://github.com/PrismJS/prism-themes prism-a11y-dark.min.css
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,email,facebook,twitter,telegram,messenger', // 分享的服務，按顺序显示,逗号隔开
  ...
  WIDGET_PET_LINK:
      ...
      'https://cdn.jsdelivr.net/npm/live2d-widget-model-koharu@1.0.5/assets/koharu.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models  live2d-widget-model-wanko@1.0.5/assets/wanko.model.json
