...
const BLOG = {
  ...
  WIDGET_PET_LINK:
      ...
      'https://cdn.jsdelivr.net/npm/live2d-widget-model-miku@1.0.5/assets/miku.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models  live2d-widget-model-wanko@1.0.5/assets/wanko.model.json
